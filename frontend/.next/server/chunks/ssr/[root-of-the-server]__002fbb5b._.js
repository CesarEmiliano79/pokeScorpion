...
function Login() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchLogin"])(email, password);
            console.log(data);
            if (!data.ok) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__002fbb5b._.js.map